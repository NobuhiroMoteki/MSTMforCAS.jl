...
\author{N.\ Moteki}
\date{Last updated: 2026-03-18 (corresponds to MSTMforCAS.jl v0.1.1)}
...
\begin{tabular}{@{} p{4.2cm} p{2.8cm} p{4.2cm} p{3.5cm} @{}}
  ...
  CBICG solver & \eqref{eq:global-system}, \eqref{eq:adjoint-symmetry}--\eqref{eq:convergence} & \texttt{solve\_bicg} & \texttt{TMatrixSolver.jl} \\
