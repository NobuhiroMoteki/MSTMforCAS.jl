...
\author{N.\ Moteki}
\date{Last updated: 2026-03-28 (corresponds to MSTMforCAS.jl v1.0.1)}
...
This bottleneck is addressed by two complementary measures:
\begin{enumerate}
...
\end{enumerate}
Running with \texttt{julia -t auto} activates both mechanisms.
